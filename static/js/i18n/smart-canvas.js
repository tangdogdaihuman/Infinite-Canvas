(function(){
    ...
    window.StudioI18n.register({
      ...
      "smart.tripoRecommended": { zh: "推荐", en: "Recommended" },
      "smart.tripoLinkedHint": { zh: "空槽位将按顺序使用连线输入图片（当前 {count} 张）", en: "Empty slots use linked images in order ({count} available)" },
      "smart.tripoLinkedHintSingle": { zh: "不上传时使用连线输入的第一张图（当前 {count} 张）", en: "Uses the first linked image when empty ({count} available)" },
      "smart.tripoFillFromLinks": { zh: "从连线填充", en: "Fill from links" },
      "smart.tripoNoUpstream": { zh: "没有可用的连线图片", en: "No linked images available" },
      "smart.tripoPromptPlaceholder": { zh: "描述要生成的 3D 模型…（可连线 Prompt 节点）", en: "Describe the 3D model to generate… (Prompt node can be linked)" },
      "smart.tripoModel": { zh: "模型", en: "Model" },
      "smart.tripoModelNote": { zh: "四视图不支持 P1，已在列表中隐藏", en: "P1 is hidden here because it does not support multiview" },
      "smart.tripoGeometryQuality": { zh: "几何精度", en: "Mesh quality" },
      "smart.tripoAuto": { zh: "自动", en: "Auto" },
      "smart.tripoParts": { zh: "自动分件", en: "Split parts" },
      "smart.tripoAutofix": { zh: "修复输入图", en: "Autofix input" },
      "smart.tripoEstimate": { zh: "预计", en: "Est." },
      "smart.tripoCredits": { zh: "点", en: "credits" },
      "smart.tripoStop": { zh: "停止等待", en: "Stop waiting" },
      "smart.tripoStopHint": { zh: "服务端任务仍会继续并消耗点数", en: "The server-side task keeps running and still consumes credits" },
